...
import com.example.myetesito.Json.Cuenta;
import com.example.myetesito.Json.Info;
import com.example.myetesito.Json.Json;
import com.example.myetesito.List.MyAdapter;
import com.example.myetesito.List.MyAdapterEdit;
import com.example.myetesito.List.MyAdapterRemove;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.MenuCerrarSesionrId:
                ...
                startActivity( intent1 );
                break;
            /*Aqui esta chistoso, hayq que revisar codigo y hacer pruebas*/
